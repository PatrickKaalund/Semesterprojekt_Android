...
class Item {
    ...
    Item(SpriteEntityFactory itemFactory, int size, ItemList_e item_type, PointF startLocation, Player player) {
        this.player = player;
        this.type = item_type;
        this.size = size;
    ...
    private void handlePickup() {
        Log.d("Item", type.toString() + " SIZE: " + size + " GOT PICKED UP!");
